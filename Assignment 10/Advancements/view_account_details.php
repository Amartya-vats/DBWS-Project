...
<?php
    if(isset($_POST['search'])):
        ...
        document.addEventListener('DOMContentLoaded', function(){
            addautocomplete('#email_g', 'general_account', 'email');
            addautocomplete('#website', 'general_account', 'website');
        });
        </script>
        ...
        <form action="<?php $_SERVER['PHP_SELF']?>" method = "POST">
            ...
            <input type="text" name = "email_g" placeholder = "email" id = 'email_g'>
            <br/>
            <br/>
